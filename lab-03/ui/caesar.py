...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(260, 10, 301, 101))
        font = QtGui.QFont()
        ...
        self.label_3.setGeometry(QtCore.QRect(270, 90, 271, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        # ✅ Chỉ cho nhập số nguyên từ 1 đến 25 (logic Key đúng)
        int_validator = QtGui.QIntValidator(1, 25)
